...
{
    public partial class rptHH_QRCode_3temImg_35_22 : DevExpress.XtraReports.UI.XtraReport
    {
        public rptHH_QRCode_3temImg_35_22()
        {
            InitializeComponent();
        }
        ...
        public void BindData(){
           ...
           //crBarcodeText.DataBindings.Add(new XRBinding("Text", DataSource, "MacodeText"));        
            xrBarCode.DataBindings.Add(new XRBinding("Image", DataSource, "PicCode"));
        }
