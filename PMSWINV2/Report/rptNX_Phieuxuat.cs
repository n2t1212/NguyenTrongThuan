...
{
    public partial class rptNX_Phieuxuat : DevExpress.XtraReports.UI.XtraReport
    {
        public rptNX_Phieuxuat()
        {
            InitializeComponent();
        }
        ...
        public void BindData(){
            ...
            crSumThanhtien.DataBindings.Add(new XRBinding("Text", DataSource, "Thanhtien", "{0:n0}"));
